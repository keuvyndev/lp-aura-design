# Layout da land-page criado com IA (Google Stich)

- https://stitch.withgoogle.com/
- Exportamos o layout em "Zip" e obtivemos o "Design.md"
- Exportamos em "Project Brief" e obtivemos o "prd.md"
- Baixamos Taste Skill:
  ```npm
      npx skills add https://github.com/Leonxlnx/taste-skill
      * Escolha 'design-taste-frontend'
  ```
